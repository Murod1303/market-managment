      ...
      <div className="w-full max-w-md relative z-10 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/30">
              <Sparkles className="w-3 h-3" /> Xavfsiz
            </span>
          </div>
          <p className="text-xs sm:text-sm text-slate-400 max-w-sm mx-auto">
            Do'kon tovarlari, hisob-fakturalar va kassa xarajatlarini avtomatik boshqaruv tizimi
          </p>
          ...
          {isTelegramWebAppView && (
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-sky-500/10 text-sky-300 border border-sky-500/30 mt-1">
              ...
              <span>Telegram WebApp orqali kirish</span>
            </div>
          )}
        </div>
        ...
        <div className="bg-slate-900/90 border border-slate-800/90 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl">
          <div className="flex items-center justify-between pb-4 mb-5 border-b border-slate-800/80">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-slate-200">Tizimga Kirish</span>
            </div>
            <span className="text-xs text-slate-400">Avtorizatsiya</span>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="masalan: admin yoki kassir"
          ...
          <div className="mt-6 pt-5 border-t border-slate-800/80">
            <p className="text-xs font-medium text-slate-400 mb-3 flex items-center justify-between">
              <span>Tezkor hisoblar orqali kirish:</span>
            ...
            <div className="grid grid-cols-2 gap-2.5">
              ...
              >
                ...
                <div className="text-[10px] text-slate-500 font-mono">parol: admin123</div>
              </button>
              ...
              >
                ...
                <div className="text-[10px] text-slate-500 font-mono">parol: kassa2026</div>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-900/60 border border-slate-800/70 rounded-2xl p-4 text-xs text-slate-400 flex items-start gap-3">
          ...
          <div className="space-y-1">
            <div className="font-semibold text-slate-200">Telegram Bot orqali avtorizatsiya:</div>
            <p className="leading-relaxed">
              Telegram botdan foydalanishda ham <code className="text-sky-300 font-mono bg-slate-950 px-1 py-0.5 rounded">/login admin admin123</code> buyrug'i orqali ruxsat olinadi. Bot ichidan WebApp ochilganda ham ushbu hisob bilan kiriladi.
            </p>
          </div>
        </div>
      </div>
